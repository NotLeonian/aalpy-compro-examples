...
inline constexpr std::array<unsigned char, N> ACCEPTING = {{0, 1, 0}};
...
static const int __learned_dfa_register_0000 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0000");
    return 0;
}();
} // namespace learned_dfa_0000
...
static const int __learned_dfa_register_0001 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0001");
    return 0;
}();
} // namespace learned_dfa_0001
...
inline constexpr std::array<unsigned char, N> ACCEPTING = {{0, 1, 0, 1, 0}};
...
static const int __learned_dfa_register_0010 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0010");
    return 0;
}();
} // namespace learned_dfa_0010
...
static const int __learned_dfa_register_0011 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0011");
    return 0;
}();
} // namespace learned_dfa_0011
...
static const int __learned_dfa_register_0100 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0100");
    return 0;
}();
} // namespace learned_dfa_0100
...
inline constexpr std::array<unsigned char, N> ACCEPTING = {{0, 1}};
...
static const int __learned_dfa_register_0101 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0101");
    return 0;
}();
} // namespace learned_dfa_0101
...
static const int __learned_dfa_register_0110 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0110");
    return 0;
}();
} // namespace learned_dfa_0110
...
static const int __learned_dfa_register_0111 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "0111");
    return 0;
}();
} // namespace learned_dfa_0111
...
namespace learned_dfa_1000 {
// States: 7, Alphabet: 2
// Symbol index mapping:
//   0: 0
//   1: 1

inline constexpr int N = 7;
inline constexpr int SIGMA = 2;
inline constexpr int INITIAL_STATE = 0;
...
static const int __learned_dfa_register_1000 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1000");
    return 0;
}();
} // namespace learned_dfa_1000
...
static const int __learned_dfa_register_1001 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1001");
    return 0;
}();
} // namespace learned_dfa_1001
...
static const int __learned_dfa_register_1010 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1010");
    return 0;
}();
} // namespace learned_dfa_1010
...
static const int __learned_dfa_register_1011 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1011");
    return 0;
}();
} // namespace learned_dfa_1011
...
static const int __learned_dfa_register_1100 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1100");
    return 0;
}();
} // namespace learned_dfa_1100
...
static const int __learned_dfa_register_1101 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1101");
    return 0;
}();
} // namespace learned_dfa_1101
...
inline constexpr std::array<unsigned char, N> ACCEPTING = {{0, 1, 0, 1, 1}};
...
static const int __learned_dfa_register_1110 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1110");
    return 0;
}();
} // namespace learned_dfa_1110
...
static const int __learned_dfa_register_1111 = [] {
    learned_dfa::dfas().register_dfa(INITIAL_STATE, ACCEPTING, TRANS, "1111");
    return 0;
}();
} // namespace learned_dfa_1111

int to_index(char c) { return c - '0'; }
...
int main(void) {
    ...
    for (std::string a : {"0", "1"}) {
        for (std::string b : {"0", "1"}) {
            for (std::string c : {"0", "1"}) {
                for (std::string d : {"0", "1"}) {
                    auto dfa = learned_dfa::dfas().get(a + b + c + d);

                    std::cout
                        << dfa.longest_accepted_substring_length(t, to_index)
                        << " " << dfa.count_accepted_substrings(t, to_index)
                        << "\n";
                }
            }
        }
