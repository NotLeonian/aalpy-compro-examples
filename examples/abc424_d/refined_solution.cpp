...
inline constexpr std::array<unsigned char, N> ACCEPTING = {{1, 1, 1, 1, 0}};
...
inline constexpr std::array<std::array<int, SIGMA>, N> TRANS = {{
    {{0, 0, 0, 1, 0, 0, 2, 3, 0, 0, 0, 1, 4, 4, 5,  6,
      0, 0, 0, 1, 0, 0, 2, 3, 7, 7, 7, 8, 9, 9, 10, 11}},
    {{0, 0, 0, 12, 0, 0, 2, 12, 0, 0, 0, 12, 4, 4, 5,  12,
      0, 0, 0, 12, 0, 0, 2, 12, 7, 7, 7, 12, 9, 9, 10, 12}},
    {{0, 0, 0, 1, 0, 0, 12, 12, 0, 0, 0, 1, 4, 4, 12, 12,
      0, 0, 0, 1, 0, 0, 12, 12, 7, 7, 7, 8, 9, 9, 12, 12}},
    {{0, 0, 0, 12, 0, 0, 12, 12, 0, 0, 0, 12, 4, 4, 12, 12,
      0, 0, 0, 12, 0, 0, 12, 12, 7, 7, 7, 12, 9, 9, 12, 12}},
    {{0, 0, 0, 1, 0, 0, 2, 3, 0, 0, 0, 1, 12, 12, 12, 12,
      0, 0, 0, 1, 0, 0, 2, 3, 7, 7, 7, 8, 12, 12, 12, 12}},
    {{0, 0, 0, 1, 0, 0, 12, 12, 0, 0, 0, 1, 12, 12, 12, 12,
      0, 0, 0, 1, 0, 0, 12, 12, 7, 7, 7, 8, 12, 12, 12, 12}},
    {{0, 0, 0, 12, 0, 0, 12, 12, 0, 0, 0, 12, 12, 12, 12, 12,
      0, 0, 0, 12, 0, 0, 12, 12, 7, 7, 7, 12, 12, 12, 12, 12}},
    {{0, 0, 0, 1, 0, 0, 2, 3, 0,  0,  0,  1,  4,  4,  5,  6,
      0, 0, 0, 1, 0, 0, 2, 3, 12, 12, 12, 12, 12, 12, 12, 12}},
    {{0, 0, 0, 12, 0, 0, 2, 12, 0,  0,  0,  12, 4,  4,  5,  12,
      0, 0, 0, 12, 0, 0, 2, 12, 12, 12, 12, 12, 12, 12, 12, 12}},
    {{0, 0, 0, 1, 0, 0, 2, 3, 0,  0,  0,  1,  12, 12, 12, 12,
      0, 0, 0, 1, 0, 0, 2, 3, 12, 12, 12, 12, 12, 12, 12, 12}},
    {{0, 0, 0, 1, 0, 0, 12, 12, 0,  0,  0,  1,  12, 12, 12, 12,
      0, 0, 0, 1, 0, 0, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12}},
    {{0, 0, 0, 12, 0, 0, 12, 12, 0,  0,  0,  12, 12, 12, 12, 12,
      0, 0, 0, 12, 0, 0, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12}},
...
inline constexpr std::array<std::array<int, SIGMA>, N> TRANS = {{
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      0,  0,  0,  1,  0,  0,  2,  3,  7,  7,  7,  8,  9,  9,  10, 11,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      12, 12, 12, 13, 12, 12, 14, 15, 16, 16, 16, 17, 18, 18, 19, 20}},
    {{0,  0,  0,  21, 0,  0,  2,  21, 0,  0,  0,  21, 4,  4,  5,  21,
      0,  0,  0,  21, 0,  0,  2,  21, 7,  7,  7,  21, 9,  9,  10, 21,
      0,  0,  0,  21, 0,  0,  2,  21, 0,  0,  0,  21, 4,  4,  5,  21,
      12, 12, 12, 21, 12, 12, 14, 21, 16, 16, 16, 21, 18, 18, 19, 21}},
    {{0,  0,  0,  1,  0,  0,  21, 21, 0,  0,  0,  1,  4,  4,  21, 21,
      0,  0,  0,  1,  0,  0,  21, 21, 7,  7,  7,  8,  9,  9,  21, 21,
      0,  0,  0,  1,  0,  0,  21, 21, 0,  0,  0,  1,  4,  4,  21, 21,
      12, 12, 12, 13, 12, 12, 21, 21, 16, 16, 16, 17, 18, 18, 21, 21}},
    {{0,  0,  0,  21, 0,  0,  21, 21, 0,  0,  0,  21, 4,  4,  21, 21,
      0,  0,  0,  21, 0,  0,  21, 21, 7,  7,  7,  21, 9,  9,  21, 21,
      0,  0,  0,  21, 0,  0,  21, 21, 0,  0,  0,  21, 4,  4,  21, 21,
      12, 12, 12, 21, 12, 12, 21, 21, 16, 16, 16, 21, 18, 18, 21, 21}},
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  2,  3,  7,  7,  7,  8,  21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  21, 21, 21, 21,
      12, 12, 12, 13, 12, 12, 14, 15, 16, 16, 16, 17, 21, 21, 21, 21}},
    {{0,  0,  0,  1,  0,  0,  21, 21, 0,  0,  0,  1,  21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  21, 21, 7,  7,  7,  8,  21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  21, 21, 0,  0,  0,  1,  21, 21, 21, 21,
      12, 12, 12, 13, 12, 12, 21, 21, 16, 16, 16, 17, 21, 21, 21, 21}},
    {{0,  0,  0,  21, 0,  0,  21, 21, 0,  0,  0,  21, 21, 21, 21, 21,
      0,  0,  0,  21, 0,  0,  21, 21, 7,  7,  7,  21, 21, 21, 21, 21,
      0,  0,  0,  21, 0,  0,  21, 21, 0,  0,  0,  21, 21, 21, 21, 21,
      12, 12, 12, 21, 12, 12, 21, 21, 16, 16, 16, 21, 21, 21, 21, 21}},
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      0,  0,  0,  1,  0,  0,  2,  3,  21, 21, 21, 21, 21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      12, 12, 12, 13, 12, 12, 14, 15, 21, 21, 21, 21, 21, 21, 21, 21}},
    {{0,  0,  0,  21, 0,  0,  2,  21, 0,  0,  0,  21, 4,  4,  5,  21,
      0,  0,  0,  21, 0,  0,  2,  21, 21, 21, 21, 21, 21, 21, 21, 21,
      0,  0,  0,  21, 0,  0,  2,  21, 0,  0,  0,  21, 4,  4,  5,  21,
      12, 12, 12, 21, 12, 12, 14, 21, 21, 21, 21, 21, 21, 21, 21, 21}},
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  2,  3,  21, 21, 21, 21, 21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  21, 21, 21, 21,
      12, 12, 12, 13, 12, 12, 14, 15, 21, 21, 21, 21, 21, 21, 21, 21}},
    {{0,  0,  0,  1,  0,  0,  21, 21, 0,  0,  0,  1,  21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  21, 21, 21, 21, 21, 21, 21, 21, 21, 21,
      0,  0,  0,  1,  0,  0,  21, 21, 0,  0,  0,  1,  21, 21, 21, 21,
      12, 12, 12, 13, 12, 12, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21}},
    {{0,  0,  0,  21, 0,  0,  21, 21, 0,  0,  0,  21, 21, 21, 21, 21,
      0,  0,  0,  21, 0,  0,  21, 21, 21, 21, 21, 21, 21, 21, 21, 21,
      0,  0,  0,  21, 0,  0,  21, 21, 0,  0,  0,  21, 21, 21, 21, 21,
      12, 12, 12, 21, 12, 12, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21}},
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      0,  0,  0,  1,  0,  0,  2,  3,  7,  7,  7,  8,  9,  9,  10, 11,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
...
inline constexpr std::array<std::array<int, SIGMA>, N> TRANS = {{
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      ...
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
},
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      0,  0,  0,  1,  0,  0,  2,  3,  37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      12, 12, 12, 13, 12, 12, 14, 15, 37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      0,  0,  0,  1,  0,  0,  2,  3,  37, 37, 37, 37, 37, 37, 37, 37,
      21, 21, 21, 22, 21, 21, 23, 24, 21, 21, 21, 22, 25, 25, 26, 27,
      28, 28, 28, 29, 28, 28, 30, 31, 37, 37, 37, 37, 37, 37, 37, 37}},
    {{0,  0,  0,  37, 0,  0,  2,  37, 0,  0,  0,  37, 4,  4,  5,  37,
      0,  0,  0,  37, 0,  0,  2,  37, 37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  37, 0,  0,  2,  37, 0,  0,  0,  37, 4,  4,  5,  37,
      12, 12, 12, 37, 12, 12, 14, 37, 37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  37, 0,  0,  2,  37, 0,  0,  0,  37, 4,  4,  5,  37,
      0,  0,  0,  37, 0,  0,  2,  37, 37, 37, 37, 37, 37, 37, 37, 37,
      21, 21, 21, 37, 21, 21, 23, 37, 21, 21, 21, 37, 25, 25, 26, 37,
      28, 28, 28, 37, 28, 28, 30, 37, 37, 37, 37, 37, 37, 37, 37, 37}},
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  2,  3,  37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  37, 37, 37, 37,
      12, 12, 12, 13, 12, 12, 14, 15, 37, 37, 37, 37, 37, 37, 37, 37,
      ...
      28, 28, 28, 29, 28, 28, 30, 31, 37, 37, 37, 37, 37, 37, 37, 37}},
    {{0,  0,  0,  1,  0,  0,  37, 37, 0,  0,  0,  1,  37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  37, 37, 37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  37, 37, 0,  0,  0,  1,  37, 37, 37, 37,
      12, 12, 12, 13, 12, 12, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  37, 37, 0,  0,  0,  1,  37, 37, 37, 37,
      0,  0,  0,  1,  0,  0,  37, 37, 37, 37, 37, 37, 37, 37, 37, 37,
      21, 21, 21, 22, 21, 21, 37, 37, 21, 21, 21, 22, 37, 37, 37, 37,
      28, 28, 28, 29, 28, 28, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37}},
    {{0,  0,  0,  37, 0,  0,  37, 37, 0,  0,  0,  37, 37, 37, 37, 37,
      0,  0,  0,  37, 0,  0,  37, 37, 37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  37, 0,  0,  37, 37, 0,  0,  0,  37, 37, 37, 37, 37,
      12, 12, 12, 37, 12, 12, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37,
      0,  0,  0,  37, 0,  0,  37, 37, 0,  0,  0,  37, 37, 37, 37, 37,
      0,  0,  0,  37, 0,  0,  37, 37, 37, 37, 37, 37, 37, 37, 37, 37,
      21, 21, 21, 37, 21, 21, 37, 37, 21, 21, 21, 37, 37, 37, 37, 37,
      28, 28, 28, 37, 28, 28, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37}},
    {{0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
      0,  0,  0,  1,  0,  0,  2,  3,  7,  7,  7,  8,  9,  9,  10, 11,
      0,  0,  0,  1,  0,  0,  2,  3,  0,  0,  0,  1,  4,  4,  5,  6,
...
void solve() {
    ...
    auto dfa = learned_dfa::dfas().get(std::to_string(w));
    std::vector<int> dp_table(dfa.state_size(), INF),
        next_table(dfa.state_size(), INF);
    dp_table[dfa.index_of_initial_state()] = 0;

    for (int i = 0; i < h; i += 1) {
        std::fill(next_table.begin(), next_table.end(), INF);
        for (int src = 0; src < dfa.state_size(); src += 1) {
            for (int label = 0; label < dfa.alphabet_size(); label += 1) {
                int cost = 0;
                for (int j = 0; j < w; j += 1) {
                    if (s[i][j] == '.') {
                        if ((label >> j) % 2 == 1) {
                ...
                int cand = dp_table[src] + cost;
                int &target = next_table[dfa.next(src, label)];
                if (target > cand) {
                    target = cand;
                }
            }
    ...
    int ans = INF;
    for (int src = 0; src < dfa.state_size(); src += 1) {
        if (dfa.is_accepting(src)) {
            int cand = dp_table[src];
            int &target = ans;
            if (target > cand) {
                target = cand;
            }
